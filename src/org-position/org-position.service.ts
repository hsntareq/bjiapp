...
const DEFAULT_POSITIONS: Record<string, { title: string; group: string }[]> = {
  ...
  THANA: [
    { title: 'President', group: 'TOP' },
    { title: 'Secretary', group: 'TOP' },
    { title: 'Office Secretary', group: 'EXECUTIVE' },
    { title: 'Organizing Secretary', group: 'EXECUTIVE' },
    { title: 'Baitulmal Secretary', group: 'EXECUTIVE' },
