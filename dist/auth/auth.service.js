...
let AuthService = class AuthService {
    ...
    async register(data) {
        if (!data.email && !data.mobile) {
            throw new common_1.HttpException('Email or mobile is required', common_1.HttpStatus.BAD_REQUEST);
        }
        if (data.email) {
        ...
        if (data.mobile) {
            ...
            if (existing) {
                throw new common_1.HttpException('Mobile already registered', common_1.HttpStatus.CONFLICT);
            }
        }
